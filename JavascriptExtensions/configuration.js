...
[fuel.time.property]
# Leave this property empty in games where you want the dashboard to calculate the remaining laps dynamically
# from your chosen fuel usage + fuel state properties.
# We want this for LMU because the LMU plugins 'remembers' fuel usage from previous sessions, so it doesn't need
# 5 fresh clean laps to update remaining time
...
# from your chosen fuel usage + fuel state properties.
# We want this for LMU because the LMU plugins 'remembers' fuel usage from previous sessions, so it doesn't need
# 5 fresh clean laps to update remaining laps
LMU = ""
...
[fuel.nrgState.transformation.ERSPercent.AssettoCorsa]
...
fr = { optimal = 26, goodThreshold = 1.5, criticalThreshold = 2 }
fl = { optimal = 26, goodThreshold = 1.5, criticalThreshold = 2 }
rl = { optimal = 24.5, goodThreshold = 1.5, criticalThreshold = 2 }
rr = { optimal = 24.5, goodThreshold = 1.5, criticalThreshold = 2 }
